...
// Route scenario calculations through the empirical official-data model.
...
if (updated !== source) {
  ...
  console.log("Scenario UI routed to empirical official-data models; unverified planning modes hidden.");
} else {
  console.log("Scenario source is already routed to empirical official data.");
}
